                ...
                <div class="col-lg-8 col-md-10">
                    ...
                    <form action="usuario.php" method="post" class="needs-validation " novalidate>
                        <div class="mb-2 col-sm-12">
                            ...
                            <input type="email" class="form-control" id="email" aria-describedby="emailHelp" placeholder="Insira um email" required>
                        </div>
                        <div class="mb-5 col-sm-12">
                            <label for="password" class="form-label">Senha</label>
                            <input type="password" class="form-control" id="password" placeholder="Insira uma senha" required> 
                        </div>
